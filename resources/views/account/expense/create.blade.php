...
<div class="page-header">
    ...
    <a href="{{ route('account.expense.index') }}" class="btn btn-outline-secondary">← Back</a>
</div>
<div class="form-card" style="max-width:600px">
    <form method="POST" action="{{ route('account.expense.store') }}">
        @csrf
        <div class="row g-3">
            <div class="col-12">
            ...
            <div class="col-md-6">
                ...
                <input type="text" name="category" class="form-control" value="{{ old('category') }}"
                    list="exp-cats" placeholder="e.g. Rent, Salary, Utilities" required>
